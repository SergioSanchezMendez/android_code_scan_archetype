 ...
 * CameraPreview
 *
 * This class manages the preview byte[] from the Camera and allows its configuration
 *
 * @author  Safon Bookstore
 * @since   1.0
 */
...
public class CameraPreview extends SurfaceView implements SurfaceHolder.Callback {
    ...
    private static final int AUTOFOCUS_REQUEST_DELAY = 100;     //Original set to 1000
    ...
    public void showCameraPreview() {
        if(mCameraWrapper != null) {
            try {
                ...
                // TODO Verify if Camera configuration can persistent (move to init method)
                // TODO Verify if other setters can also be maintained between this method calls
    ...
    public void setupCameraParameters() {
        ...
        // Preprocess 1. Continuous Filter
        //parameters.setFocusMode(Camera.Parameters.FOCUS_MODE_CONTINUOUS_VIDEO);
        //parameters.setFocusMode(Camera.Parameters.FOCUS_MODE_CONTINUOUS_PICTURE);
        parameters.setFocusMode(Camera.Parameters.FOCUS_MODE_AUTO);

        // TODO. Preprocess. Limit focus area to square


        // TODO TEST. Filter. Select a low resolution picture
    ...
    private Camera.Size getOptimalPreviewSize() {
        ...
        // TODO Preprocess 1. Maximum reduction of the resolution acquired
        // Hack.Choose the minimal, suitable to detect codes
        //for (Camera.Size size : sizes) {
        //Log.i(TAG, "Available resolution: "+size.width+" "+size.height);
        //optimalSize = size;
        //break;
    ...
    private void scheduleAutoFocus() {
        mAutoFocusHandler.postDelayed(doAutoFocus, AUTOFOCUS_REQUEST_DELAY);
    }
}
